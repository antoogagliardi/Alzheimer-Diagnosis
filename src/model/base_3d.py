...
class UNetAlzheimer3D(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        output_pred, brain_features_3, brain_features_2, brain_features_1 = self(input_img)
    ...
    def on_train_epoch_end(self):
        ...
        cm = self.train_disease_confusion_matrix.compute()# .numpy();
        ...
        cm = self.valid_disease_confusion_matrix.compute()#.numpy();
        cm = cm.cpu().detach().numpy()
        plot_confusion_matrix(cm=cm, out_class=["CN", "MCI", "AD"],
